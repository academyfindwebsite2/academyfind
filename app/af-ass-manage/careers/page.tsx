    ...
    return (
        <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-8">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <Link href="/af-ass-manage/careers/resumes">
                ...
                <Link href="/af-ass-manage/careers/new">
                        ...
                        {jobs.map((job: any) => (
                            <tr key={job.id} className="hover:bg-slate-50/50 transition">
                                ...
                                <td className="p-4 text-center">
                                    <Link href={`/af-ass-manage/careers/${job.id}`} className="inline-flex items-center gap-2 bg-blue-50 hover:bg-blue-100 text-blue-700 px-4 py-2 rounded-xl font-bold transition">
                                ...
                                <td className="p-4 text-right">
                                    <div className="flex items-center justify-end gap-3">
                                        ...
                                        <Link href={`/af-ass-manage/careers/${job.id}/edit`} className="text-purple-600 hover:text-purple-800 font-bold text-xs uppercase tracking-wider">
                                            Edit Post
                                        </Link>
                                    </div>
                                </td>
