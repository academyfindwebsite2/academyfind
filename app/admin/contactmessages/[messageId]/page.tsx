...
export default async function ContactMessageDetail({ params }: { params: Promise<{ messageId: string }> }) {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6 pb-12 font-sans animate-in fade-in duration-300">
            ...
            {/* Back Button */}
            <Link href="/admin/contactmessages" className="inline-flex items-center text-sm font-semibold text-slate-500 hover:text-blue-600 transition-colors bg-white px-4 py-2 rounded-xl border border-slate-200 shadow-sm">
