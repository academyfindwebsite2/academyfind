        ...
        <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in duration-500">
            ...
            <div className="bg-white border border-stone-200 rounded-3xl p-8 shadow-sm">
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-8">
                    <a href={`tel:${enquiry.phone}`} className="flex items-center gap-3 p-4 rounded-2xl bg-stone-50 border border-stone-100 hover:border-emerald-200 hover:bg-emerald-50 transition group">
                        ...
                        <div>
                            ...
                            <p className="font-semibold text-stone-800">{enquiry.phone}</p>
                        </div>
                    </a>
                </div>
